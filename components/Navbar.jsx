      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 lg:px-24">
        <div className="flex items-center justify-between">
          ...
          <ul className="hidden lg:flex items-center space-x-2 sm:space-x-4">
            <NavItems session={session} logout={logout} closeMenu={closeMenu} />
          </ul>
        </div>
        <div
        ...
        <>
          ...
          <li className={itemClass}>
            <Link href="/auth/sign-in" onClick={closeMenu}>
              <button className="whitespace-nowrap px-4 py-2 bg-gray-800 text-white rounded-md hover:bg-gray-600 transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-offset-2">
                Sign in
              </button>
            </Link>
          </li>
        ...
        <>
          ...
          <li className={`${itemClass} relative group`}>
            ...
            <div
              className={`${
                mobile
                  ? "mt-2 mr-4"
                  : "absolute right-0 mt-2 w-48 bg-navbar rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-in-out"
              }`}
            >
              <Link
          ...
          <li className={itemClass}>
            <form action={logout}>
              <button
                type="submit"
                className="whitespace-nowrap px-4 py-2 bg-gray-800 text-white rounded-md hover:bg-gray-600 transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-offset-2"
                onClick={closeMenu}
              >
                Sign out
              </button>
